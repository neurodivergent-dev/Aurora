    ...
    >
      ...
      >
        <View style={styles.iconContainer}>
          <View
            style={[styles.iconBackground, { backgroundColor: isDarkMode ? 'rgba(255, 255, 255, 0.05)' : colors.card, borderColor: isDarkMode ? 'rgba(255, 255, 255, 0.1)' : 'transparent', borderWidth: 1 }]}
          >
        ...
        >
          ...
          <View style={styles.policyItem}>
            <CheckCircle
              size={20}
              color={isDarkMode ? '#32D74B' : colors.success}
              style={styles.policyIcon}
            />
            <Text style={[styles.policyText, { color: colors.text }]}>
              <Text style={styles.bold}>
